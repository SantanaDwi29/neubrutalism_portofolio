...
export const projects: Project[] = [
  {
    ...
    images: [
      '/projectt/saddasa/1.webp',
      '/projectt/saddasa/2.webp',
      '/projectt/saddasa/3.webp'
    ],
  ...
  },
  {
    ...
    images: [
      '/projectt/sarustudio/1.webp',
      '/projectt/sarustudio/2.webp',
      '/projectt/sarustudio/3.webp',
      '/projectt/sarustudio/4.webp',
      '/projectt/sarustudio/5.webp',
      '/projectt/sarustudio/6.webp',
      '/projectt/sarustudio/7.webp',
      '/projectt/sarustudio/8.webp',
      '/projectt/sarustudio/9.webp'
    ],
    role: 'Full-stack Developer',
...

  {
    ...
    images: [
      '/projectt/kitagiat/1.webp',
      '/projectt/kitagiat/2.webp',
      '/projectt/kitagiat/3.webp',
      '/projectt/kitagiat/4.webp',
      '/projectt/kitagiat/5.webp',
      '/projectt/kitagiat/6.webp',
      '/projectt/kitagiat/kitagiat_absensi.webp',
      '/projectt/kitagiat/Screenshot 2025-11-30 214458.webp',
  ...
  },
  {
    ...
    images: [
      '/projectt/kitagiat/AdminPortal/1.webp',
      '/projectt/kitagiat/AdminPortal/2.webp',
      '/projectt/kitagiat/AdminPortal/3.webp',
      '/projectt/kitagiat/AdminPortal/4.webp',
      '/projectt/kitagiat/AdminPortal/5.webp',
      '/projectt/kitagiat/AdminPortal/6.webp',
      '/projectt/kitagiat/AdminPortal/7.webp',
      '/projectt/kitagiat/AdminPortal/8.webp',
      '/projectt/kitagiat/AdminPortal/9.webp',
      '/projectt/kitagiat/AdminPortal/10.webp',
      '/projectt/kitagiat/AdminPortal/11.webp',
      '/projectt/kitagiat/AdminPortal/12.webp',
      '/projectt/kitagiat/AdminPortal/13.webp'
    ],
    role: 'Full-stack Developer',
  ...
  },
  {
    ...
    images: ['/projectt/jagadhita.webp'],
  ...
  },
  {
    ...
    images: [
      '/projectt/sapabaru/awalpage.webp',
      '/projectt/sapabaru/login.webp',
      '/projectt/sapabaru/register.webp',
      '/projectt/sapabaru/tambah=pendatang.webp',
      '/projectt/sapabaru/verifikasi.webp',
      '/projectt/sapabaru/view,data.webp'
    ],
    role: 'Full-stack Developer',
...

  {
    ...
    images: ['/projectt/assaFarma.webp'],
    role: 'Full-stack Developer',
