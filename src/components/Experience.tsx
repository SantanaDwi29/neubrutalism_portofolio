  ...
  return (
    <section id="experience" className="space-y-12">
      <h2 className="font-headline-lg text-headline-lg uppercase flex items-center gap-4">
        <span className="material-symbols-outlined text-4xl" data-icon="work_history">work_history</span> Experience
      </h2>
      ...
      <div className="space-y-6">
        ...
        {/* Internship */}
        <div className="bg-[#FFE566] border-[3px] border-black p-6 md:p-8 hard-shadow flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:-translate-y-1 transition-transform">
          <div>
            <div className="inline-block bg-white border-2 border-black px-3 py-1 mb-4 font-label-bold uppercase text-xs">
              Internship
            </div>
